...
// Change-Detector-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX - for Espresso.app
...
if ( $host != 'coworking-neuchatel.ch' ) {
 ...
 if ( $cowork_dev_mode == true ) {
 		...
 		wp_enqueue_style( 
 				'cowork-style', 
 				get_stylesheet_directory_uri() . '/css/build/styles.20181218165558.css', // main.css
 				false, // dependencies
 				null // version
 		); 
 }
